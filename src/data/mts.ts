...
export const mtsChecklist: ChecklistItem[] = [
  // Шрифты
  ...
  // Кнопка
  {
    id: 'btn-clickarea',
    category: 'Кнопка',
    text: 'Кликабельная область вписана в границы кнопки (исключая рамку и тень)',
    critical: true,
  },
  {
    id: 'btn-width',
  ...
  { id: 'btn-one', category: 'Кнопка', text: 'Кнопка активации одна на странице', critical: true },
  {
    id: 'btn-text-mts',
    category: 'Кнопка',
    text: 'Текст кнопки из допустимых: Смотреть, Слушать, Получить доступ, Подписаться и др.',
    critical: true,
  },
  {
    id: 'btn-default-voiti',
    category: 'Кнопка',
    text: 'LP по умолчанию: кнопка содержит слово «Войти»',
    critical: false,
  },
  ...
  },
  {
    id: 'checkbox-18',
    category: 'Чек-бокс',
    text: 'Текст: «Я согласен с правилами услуги и мне есть 18 лет»',
    critical: true,
  },
  ...
  // Структура
  {
    id: 'exit-btn',
    category: 'Структура',
    text: 'Кнопка «Выйти» / «Назад» / «Отмена» — ведёт на предыдущую страницу или главную сервиса',
    critical: true,
  },
  {
    id: 'age-sign',
  ...
  },
  {
    id: 'unique',
    category: 'Структура',
    text: 'LP уникален: заменены фон, цвет кнопки и графические элементы',
    critical: true,
  },
  ...
  },
  {
    id: 'archive-aliases',
    category: 'Архив',
    text: 'Алиасы: {{cost}}, {{conditions}}, {{reject}}, {{servicelink}}, {{pre-header}}, {{lk-user-mts}}, {{app-link}}',
    critical: true,
  },
  {
    id: 'archive-no-mts-brand',
    category: 'Архив',
    text: 'Нет товарного знака МТС в названии/URL',
    critical: true,
  },
